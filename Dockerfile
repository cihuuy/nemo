...
RUN apt-get install -y dbus-x11 sudo bash net-tools novnc firefox  x11vnc xvfb supervisor xfce4 gnome-shell python3.8 ubuntu-gnome-desktop gnome-session gdm3 tasksel ssh git screenfetch nano curl wget zip unzip docker.io
